...
class Page:
	def __init__(self, state: Union[Any, None]):
		...
		self.join1 = state["join1"] if "join1" in state else None
	...
	@property
	def join1(self):
		self._getter_access_tracker["join1"] = {}
		return self._join1
	@join1.setter
	def join1(self, new_state):
		self._setter_access_tracker["join1"] = {}
		self._join1 = Flex(new_state)
